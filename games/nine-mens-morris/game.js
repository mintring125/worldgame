...
function drawBoardLines(boardEl) {
    ...
    // 연결선
    createLine(boardEl, 180, 20, 100, false);   // 상단 연결
    createLine(boardEl, 180, 240, 100, false);  // 하단 연결
    createLine(boardEl, 20, 180, 100, true);    // 좌측 연결
    createLine(boardEl, 240, 180, 100, true);   // 우측 연결
}
